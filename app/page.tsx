...
───────────────────────────────────────────── */// ─── TIPE DATA ───────────────────────────────
type TabType = "tentang" | "proposal" | "transparansi" | "marketplace";interface Transaksi {
  id: number;
  tanggal: string;
  keterangan: string;
  kategori: string;
...
const ALOKASI = [
  ...
  { label: "Bank Sampah & Eco-Waste", target: 1500000, icon: "", color: "#6B4F3A" },
  { label: "DKM & Sosial", target: 1000000, icon: "", color: "#8A7065" },
  { label: "Marketplace Digital", target: 1000000, icon: "", color: "#3D5C8A" },
];// ─── HELPER ─────────────────────────────────────
const formatRp = (n: number) =>
  "Rp " + n.toLocaleString("id-ID");export default function Home() {
  ...
  const [proposalSection, setProposalSection] = useState<number | null>(null);  useEffect(() => {
  ...
  }, [activeTab, showCheckout]);  // ─── KALKULASI DONASI ──────────────────────
  ...
  const totalTarget = ALOKASI.reduce((s, a) => s + a.target, 0);  // Dana per kategori (untuk progress alokasi)
  ...
  DATA_TRANSAKSI.filter((t) => t.tipe === "keluar").forEach((t) => {
    ...
    filterTipe === "semua" ? DATA_TRANSAKSI : DATA_TRANSAKSI.filter((t) => t.tipe === filterTipe);  // Paguyuban data
  const orgDesa = [
    { role: "Tokoh Agama / Pelindung", name: "— Soon —", icon: "" },
    { role: "Ketua RW / Pelindung", name: "Bpk. Enang", icon: "" },
    ...
    <>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .font-display{font-family:'Cormorant Garamond',serif;}    /* reveal */
          ...
          <div style={{ maxWidth: 1320, margin: "0 auto", width: "100%" }}>
            ...
            <div className="h5" style={{ display: "flex", flexWrap: "wrap", gap: 16, alignItems: "flex-end" }}>
              ...
              <div style={{ display: "flex", gap: 10, flexWrap: "wrap", marginLeft: "auto" }}>
                {[" Pertanian", " Peternakan", " Kerajinan Bambu", " Smart PJU", " Eco-Waste", " Learning Hub"].map((tag) => (
          ...
          <div style={{ maxWidth: 1320, margin: "0 auto", display: "flex", flexWrap: "wrap", gap: 56, alignItems: "flex-start" }}>
            ...
            <div style={{ flex: 1, minWidth: 260, display: "flex", flexDirection: "column", gap: 8 }}>
              {[
                ...
                { no: "03", icon: "", t: "Ekologi & Ekonomi Sirkular", d: "Mengubah masalah sampah menjadi sumber pendapatan melalui Bank Sampah Digital dan upcycling limbah." },
              ...
              content: (
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 14 }}>
                  {[
                    ...
                    { icon: "", t: "Ekologi & Ekonomi Sirkular", d: "Mengubah sampah menjadi sumber pendapatan melalui Bank Sampah Digital." },
              ...
              content: (
                <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                  {[
                    ...
                    { icon: "", t: "Circular Eco-Waste (Bank Sampah)", d: "Sampah organik → kompos/pakan ternak. Plastik → kerajinan atau material siap jual." },
