...
>
 ...
 {["Pertanian Organik", "Kerajinan Bambu", "Eco-Waste", "Learning Hub"].map(tag => (
 <span
 key={tag}
 style={{
 padding: "6px 14px",
 ...
 >
 <BookOpen size={18} style={{display:"inline", marginRight:6}}/> Our Story
 </button>
 </div>
 </div>
...
<div id="content-start" style={{ background: "var(--fo)", overflow: "hidden", padding: "10px 0" }}>
 ...
 icon: <Vote strokeWidth={1.5} size={28} />, 
 link: "/voting",
 color: "#2F8F4E",
 tag: "MUSYAWARAH",
 comingSoon: false
 ...
 icon: <Stethoscope strokeWidth={1.5} size={28} />, 
 link: "/posyandu",
 color: "#8B2020",
 tag: "KESEHATAN",
 comingSoon: false
 ...
 icon: <HandHeart strokeWidth={1.5} size={28} />, 
 link: "/zakat",
 color: "#B8943F",
 tag: "DKM / SOSIAL",
 comingSoon: false
 ...
 icon: <Megaphone strokeWidth={1.5} size={28} />, 
 link: "/pengaduan",
 color: "#2D5A40",
 tag: "RESPONS CEPAT",
 comingSoon: false
 ...
 icon: <HandCoins strokeWidth={1.5} size={28} />, 
 link: "/tukar-poin",
 color: "#B8943F",
 tag: "ECO-REWARD",
 comingSoon: false
