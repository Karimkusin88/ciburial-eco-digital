                            ...
                            <div className="donasi-panel-dark" style={{ background: "var(--fo)", padding: "clamp(32px, 6vw, 60px) clamp(24px, 5vw, 52px)" }}>
                                ...
                                <div style={{ display: "flex", flexDirection: "column", gap: 12, marginBottom: 24 }}>
                                    {[
                                        ...
                                        { id: "evm", icon: <Coins size={24} strokeWidth={1.5} />, l: "Crypto (EVM)", s: "Donasi via Jaringan Blockchain", rek: "0x71723715478b344164e992b49ae1fceb6467888b", an: "EVM Wallet", ket: "ETH, BSC, Polygon, dll" },
                                        { id: "paypal", icon: <img src="https://upload.wikimedia.org/wikipedia/commons/a/a4/Paypal_2014_logo.png" alt="PayPal" width={24} height={24} style={{ objectFit: "contain" }} />, l: "PayPal", s: "Donasi Internasional", rek: "@ciburialecodigital", an: "Akun PayPal Resmi", ket: "Worldwide" }
                                    ].map((m, i) => {
