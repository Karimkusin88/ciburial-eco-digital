          ...
          <div style={{ marginTop: 40, padding: 0 }}>
            ...
            <div className="donasi-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 260px), 1fr))", gap: "clamp(14px, 3vw, 20px)" }}>
              {[
                ...
                { 
                  icon: <img src="https://upload.wikimedia.org/wikipedia/commons/a/a4/Paypal_2014_logo.png" alt="PayPal" width={24} height={24} style={{ objectFit: "contain" }} />, 
                  title: "PayPal", 
                  desc: "Donasi internasional melalui akun PayPal",
                  detail: "@ciburialecodigital",
                  copyText: "@ciburialecodigital"
                }
              ].map((m, i) => (
